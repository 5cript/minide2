...
namespace SettingParts
{
    class Environment
    {
      public:
        ...
        // msys2 uses the linux splitter on windows. then there is cygwin, vms, the remote might need the environment of
        // the host for whatever reason. Lets assume we dont exactly know whats needed.
